...
For $p=1$ we additionally allow one electron or hole excitation.
...
Lastly it works very well if our matrix is sparse which is the case for our Hamiltonian\footnote{
