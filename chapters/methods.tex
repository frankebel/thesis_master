...
operators onto $\ket{\psi_0}$ simultaneously where the subscript $K_{11}$ is meant
as the first $q\times q$ block of the matrix $K$
\begin{equation}
    C^\pm_\omega
    =
    B_0 \left[\frac{1}{\omega + \mi0^+ \mp T}\right]_{11} B_0.
...
\end{equation}
at half-filling.
Diagonality comes from the quadratic shift in \zcref{eq:quadratic-shift}.
