...
For the special case of the Bethe lattice (\zcref{sec:bethe-lattice}),
...
\end{equation}
with a derivation given in TODO. % TODO: derive DMFT for Bethe lattice
...
\end{equation}
Notably,
the spectrum of the non-interacting hybridization function $\Delta_{0,\omega}$
