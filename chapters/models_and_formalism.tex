...
This relation can be rewritten by using the half-bandwidth $D = W/2 = 2t$ instead:
\begin{equation}
...
of a particle returning to its origin at time $t$~\cite{Economou2006}.
...
partial correlators with poles on the positive and negative real axis respectively.
...
\begin{equation}
    ...
    \label{eq:moments}
\end{equation}
allowing us to write a high-frequency expansion~\cite{Potthoff1997}
\begin{equation}
...
allowing us to write down a high-energy expansion~\cite{Potthoff1997}
\begin{equation}
...
$\Sigma^\mIFG_\omega$ by \citeauthor{Kugler2022}~\cite{Kugler2022}
...
of \zcref{eq:H-Anderson} which leads to the given Green's function $G_{0,\omega}$.
...
lattice Green's function $G_\omega \equiv G_{\mloc,\omega}$.
