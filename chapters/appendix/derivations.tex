...
\section{DMFT self-consistency on the Bethe lattice}
...
\end{align}
Comparing the right sides of \zcref{eq:impurity-gf-non-interacting} and \zcref{eq:impurity-gf-interacting},
