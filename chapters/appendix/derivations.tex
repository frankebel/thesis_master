...
\begin{equation}
    C^+_\omega
    =
    \lim_{\delta\to 0^+} \left\langle A \frac{1}{z - H + E_0} B\right\rangle
    =
...
\section{Integration of the spectral function}
\label{app:spectral-function-integration}

Proof that the integral of the spectral function is unity.
\begin{align}
    \int_{-\infty}^\infty\! \md\omega\> A_\omega
     & =
