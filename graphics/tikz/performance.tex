...
\begin{tikzpicture}
    ...
    \begin{groupplot}
        ...
        \addplot+ table [x=krylov, y=time_L3_p1] {data/benchmark_krylov.csv};
        ...
        \addplot+ table [x=bath, y=time_L3_p1] {data/benchmark_bath.csv};
        ...
        \addplot+ table [x=krylov, y=allocations_L3_p1] {data/benchmark_krylov.csv};
        ...
        \addplot+ table [x=bath, y=allocations_L3_p1] {data/benchmark_bath.csv};
