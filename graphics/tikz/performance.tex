...
\begin{tikzpicture}
    ...
    \begin{groupplot}
        ...
        at (rel axis cs:1,0) {\subcaption{}\label{subfig:perf-time-krylov}};
        ...
        at (rel axis cs:1,0) {\subcaption{}\label{subfig:perf-time-sites}};
        ...
        [
            ...
            ylabel={memory allocations (\unit{\byte})},
        ]
        ...
        at (rel axis cs:1,0) {\subcaption{}\label{subfig:perf-allocations-krylov}};
        ...
        at (rel axis cs:1,0) {\subcaption{}\label{subfig:perf-allocations-sites}};
